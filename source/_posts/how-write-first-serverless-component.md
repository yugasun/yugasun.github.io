...
要实现 CDN 域名的添加，需要借助2个腾讯云API 接口：[新增加速域名](https://cloud.tencent.com/document/product/228/1406)、[HTTPS 配置](https://cloud.tencent.com/document/product/228/12965)。通过阅读这两份接口文档，总结出一份配置说明文件 `config.md` ，内容如下：
